                          ...
                          return Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    decoration: boxDecorationWithRoundedCorners(backgroundColor: Colors.blue.shade500, borderRadius: radius(12)),
                                    padding: EdgeInsets.all(12),
                                    child: Text((data[index].message).validate(), style: secondaryTextStyle(color: white)),
                                  ),
                                  8.width,
                                  CircleAvatar(
                                ...
                                children: [
                                  ...
                                  Container(
                                    decoration: boxDecorationWithRoundedCorners(
                                      ...
                                      backgroundColor: mlColorLightGrey100,
                                    ),
                                    padding: EdgeInsets.all(12),
                                    child: Text(
